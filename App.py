...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Rishin@5112',db='cv')
...
def run():
    ...
    img = Image.open('./Logo/rishi.jpeg')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built by <a  style="text-decoration: none; color: #008000;"><br>Rishin<br>Anjana<br>Nikitha<br>Srilakshmi</a></b>'
    ...
    if choice == 'User':
        ...
        # Upload Resume
        st.markdown('''<h5 style='text-align: left; color: #4169E1;'> Upload Your Resume, And Get Smart Recommendations</h5>''',unsafe_allow_html=True)
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                web_keyword = ['react', 'django', 'node jS','react','Javascript','HTML','Html', 'react js', 'php', 'laravel', 'magento', 'wordpress','javascript', 'angular js', 'C#','c#', 'Asp.net', 'flask']
                android_keyword = ['android','android development','flutter','kotlin','xml','kivy']
                ios_keyword = ['ios','ios development','swift','cocoa','cocoa touch','xcode']
                uiux_keyword = ['ux','adobe xd','figma','zeplin','balsamiq','ui','prototyping','wireframes','storyframes','adobe photoshop','photoshop','editing','adobe illustrator','illustrator','adobe after effects','after effects','adobe premier pro','premier pro','adobe indesign','indesign','wireframe','solid','grasp','user research','user experience']
                n_any = ['english','communication','writing', 'microsoft office', 'leadership','customer management', 'social media','Digital Marketing']
                ...
                for i in resume_data['skills']:
                    ...
                    #### Ui-UX Recommendation
                        ...
                        st.markdown('''<h5 style='text-align: left;font-size=24px: color: #D0312D;'>Adding this skills to resume will boost🚀 the chances of getting a Job💼</h5>''',unsafe_allow_html=True)
                        # course recommendation
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin':
                ...
                st.success("Welcome Rishin and Team ! Total %d " % values + " User's Have Used Our Tool : )")
